# VetiCloud Frontend Documentation

Welcome to the VetiCloud Veterinary Management Platform frontend documentation.

## 📚 Documentation Index

### 🎨 [Color System Documentation](./COLOR-SYSTEM.md)
Complete guide to VetiCloud's color palette and design system:
...
VetiCloud uses a **two-layer color system**:
