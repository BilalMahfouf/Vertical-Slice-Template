# VetiCloud Color System Implementation Plan

**Project:** VetiCloud Veterinary Clinic Management Platform  
**Version:** 1.0.0  
**Date:** January 2026  
...
VetiCloud uses a **two-layer color system** that combines:
...
<div>
  ...
  <p className="text-slate-600">
    This patient has been under observation for 3 days.
  </p>
...
**Primary Use:** Patient recovery, successful operations, completed tasks
...
**Primary Use:** Patients under observation, pending appointments, caution
...
**Primary Use:** Critical patients, errors, delete actions, emergencies
...
**Primary Use:** Info notifications, in-progress appointments, neutral status
...
**Primary Use:** Appointment cards, calendar events, scheduling

| Shade | Hex | Usage |
|-------|-----|-------|
| **50** | `#FAF5FF` | Appointment card backgrounds |
| **100** | `#F3E8FF` | Calendar event highlights |
| **600** | `#9333EA` | Appointment indicators |

**Examples:**
```tsx
// Appointment card
<div className="bg-purple-50 border border-purple-200 p-4 rounded">
  <h3 className="text-purple-600 font-semibold">Upcoming Appointment</h3>
  <p className="text-slate-600">Dr. Johnson - 2:30 PM</p>
</div>
```
...
<div className="bg-orange-50 p-4 rounded">
  <p className="text-orange-600">3 new patients registered today</p>
</div>
```
...
<div className="bg-card border border-border rounded-lg p-4">
  <h3 className="text-card-foreground font-semibold">Patient Info</h3>
  <p className="text-muted-foreground">Last visit: 3 days ago</p>
</div>
...
Install these components in order to build the VetiCloud UI:
...
```
**Why:** Patient cards, dashboard widgets, info panels
...
```
**Why:** Patient lists, appointment tables, data grids
...
```
**Why:** Dropdowns for filters, species selection, status filters
...
```
**Why:** User profile images, patient photos
**Colors Used:** `slate-200`, `slate-400`, `muted`
**Example:**
```tsx
<Avatar>
  <AvatarImage src="/patient.jpg" alt="Patient" />
...
export function PatientCard({ patient }) {
  return (
    <Card className="hover:shadow-md transition-shadow">
      ...
      <CardContent>
        <p className="text-slate-600">Species: {patient.species}</p>
...
export function NotificationExample() {
  ...
  const showWarning = () => {
    toast({
      ...
      title: 'Warning',
      description: 'This patient is due for a checkup',
    })
  }
...
<Badge 
  className="bg-green-50 text-green-600"
  aria-label="Patient status: Stable"
>
  Stable
</Badge>
```
...
│
├─ Is it for appointments/calendar?
│  └─ Use: bg-purple-50 text-purple-600
│
...
**Version:** 1.0.0  
**Maintained By:** VetiCloud Development Team
