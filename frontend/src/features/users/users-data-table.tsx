  ...
  const usersColumns: DataTableColumn<UserRecord>[] = [
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(i18nKeyContainer.client.fullName)}
          enableSorting={false}
        />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(i18nKeyContainer.settingsPage.clinic.staff.role)}
          enableSorting={false}
        />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(i18nKeyContainer.settingsPage.clinic.staff.status)}
          enableSorting={false}
        />
      ),
      cell: ({ row }) => {
