...
export default function RenewPage() {
  ...
  console.log('RenewPage render, user subscription status:', user?.subscriptionStatus, 'clinic info completed:', user?.clinicInfromationCompleted);
  useEffect(() => {
    ...
    if (user.clinicInfromationCompleted === false) {
      navigate('/onboarding/create-clinic', { replace: true });
      return;
    }
